...
template_folder = Path(r"C:\Users\meiek\Documents\RIVUS_code\GUI\templates")

company = "036. Herrestad4"
correspondance_name = "Herrestad"
template_key = "ownPVss"  # choose from: ownPVss, ownPV, APIPVss, APIPV

COMPANY_ROOT = BASE / company
RESULTS_PATH = COMPANY_ROOT / "Results_t.xlsx"

row_selected_case_2024 = 0  # not self-sufficient, 2024 (_1)
row_selected_case_2024_ss = 0  # self-sufficient, 2024 (_2)
row_selected_case_2025 = 0  # not self-sufficient, 2025 (_3)
row_selected_case_2025_ss = 0  # self-sufficient, 2025 (_4)
...
def build_case_context(row, correspondance_name: str, additional_information: dict) -> dict:
    return {
        ...
        "ssr_t": round(row["Self-sufficiency (grid-to-demand) (SSR %)"], 1),    # COULD BE WRONG NAME
